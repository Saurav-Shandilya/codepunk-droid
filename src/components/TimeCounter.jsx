...
const TimeCounter = () => {
  ...
  const calculateTimeLeft = () => {
    ...
    const targetDate = new Date(2026, 3, 10, 10, 30, 0); // April = 3
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-12 sm:py-16 md:py-20">
        ...
        >
          <h2 
            ...
            style={{
              textShadow: `3px 3px 0px #FF3366, 6px 6px 0px #00D9FF`,
                ...
                {timeUnits.map((unit, index) => (
                  <React.Fragment key={unit.label}>
                    <div className="flex flex-col items-center min-w-[50px] sm:min-w-[70px] md:min-w-[90px]">
                      ...
                      <span className="text-[10px] sm:text-xs md:text-sm font-bold mt-2 tracking-widest uppercase">
                        {unit.label}
                      </span>
                    </div>
